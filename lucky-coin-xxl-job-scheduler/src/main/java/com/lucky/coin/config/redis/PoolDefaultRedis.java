package com.lucky.coin.config.redis;

import com.lucky.coin.config.bean.AwsRedisConfig;
import com.lucky.coin.dao.util.RedisUtil;
...
public class PoolDefaultRedis {
    ...
    public RedisStandaloneConfiguration redisConfig() {
        ...
        AwsRedisConfig redisConfig = new AwsRedisConfig();
