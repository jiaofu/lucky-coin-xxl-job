...
public interface MarketInfoMapper extends tk.mybatis.mapper.common.Mapper<MarketInfoBean> {
    ...
    @Insert({
            ...
            " `day`, `coin_id`, `symbol`, `price`, `percent_change_24h`, `percent_change_7d`, `percent_change_30d`, `coin_ranking`,`fully_diluted_market_cap`, `last_updated`) VALUES ",
            ...
            "#{record.coinRanking,jdbcType=BIGINT},#{record.fullyDilutedMarketCap,jdbcType=DECIMAL}," ,
