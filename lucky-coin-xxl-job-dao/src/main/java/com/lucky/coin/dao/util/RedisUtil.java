package com.lucky.coin.dao.util;
...
public class RedisUtil {
    ...
    public synchronized static RedisUtil getRedisUtil(String region) {
    ...
    public static Set<String> getRegionRedisUtil() {
        return redisUtils.keySet();
    }
    ...
    public <T> List<List<T>> hMultiGetWorker(String key, List items, Class<T> tClass) {
        ...
        for (Object object : objectList) {
            String jsonstr = (String) object;
            List<T> t = JSON.parseArray(jsonstr, tClass);
            list.add(t);
        }
        return list;
    }
